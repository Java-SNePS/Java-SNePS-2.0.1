...
public class ContextSet {
	...
	public void addContext(Context newContext) {
		// TODO ei far2 mabein di wel
		// tahtiha man5ali add all t
		// call di instead od add bas?
		// for (Iterator<Context> iterator = this.iterator();
		// iterator.hasNext();) {
	...
	public void add(Context context) { // TODO check for duplicates
